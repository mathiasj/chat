...
["", "client.dart", , U, {
  "^": "",
  main: [function() {
    new U.Client(false, null).connect$0();
    ...
    call$1: function(e) {
      ...
      switch (response) {
        ...
        case "info":
          ...
          break;
        default:
          t1 = "Invalid response: '" + H.S(response) + "'";
          document.querySelector("#chatWindow").textContent = t1;
      }
    }
  },
  Client_connect__closure0: {
    "^": "Closure:8;this_2",
    call$1: function(_) {
      var t1 = "Connection disconnected to " + H.S(this.this_2.webSocket.url) + ".";
      document.querySelector("#chatWindow").textContent = t1;
    }
  },
  Client_connect_closure0: {
    "^": "Closure:8;this_3",
    call$1: function(_) {
      var t1 = "Failed to connect to " + H.S(this.this_3.webSocket.url);
      document.querySelector("#chatWindow").textContent = t1;
    }
  }
},
