...
["", "../dart/client.dart", , U, {
  ...
  Client: {
    ...
    submitSay$0: function() {
      var sayTextElm, t1;
      sayTextElm = document.querySelector("#sayText");
      t1 = J.getInterceptor$x(sayTextElm);
      this.say$1(t1.get$value(sayTextElm));
      t1.set$value(sayTextElm, "");
      sayTextElm.focus();
    },
    connect$0: function() {
      this.connectPending = false;
      var t1 = W.WebSocket_WebSocket("ws://localhost:9000/ws/chat", null);
      this.webSocket = t1;
      ...
      t1.get$first(t1).then$1(new U.Client_connect_closure0(this));
    },
    updateChatWindow$1: function(str) {
      var $history, t1;
      $history = J.get$innerHtml$x(document.querySelector("#chatWindow"));
      t1 = document.querySelector("#chatWindow");
      if (typeof $history !== "string")
        return $history.$add();
      J.set$innerHtml$x(t1, C.JSString_methods.$add($history + "<div class=\"msg\">", str) + "</div>");
    },
    say$1: function(input) {
      var request;
      if (J.get$isEmpty$asx(input))
        return;
      request = P.LinkedHashMap_LinkedHashMap$_literal(["request", "newMessage", "msg", input], null, null);
      this.webSocket.send(C.JsonCodec_null_null.encode$1(request));
    },
    Client$0: function() {
      var t1 = J.get$onSubmit$x(document.querySelector("#chatForm"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new U.Client_closure(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      this.connect$0();
      t1 = J.get$onClick$x(document.querySelector("#sayButton"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new U.Client_closure0(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    },
    static: {"^": "Client_RECONNECT_DELAY", Client$: function() {
        var t1 = new U.Client(false, null);
        t1.Client$0();
        return t1;
      }}
  },
  ...
  Client_closure0: {
    "^": "Closure:10;this_1",
    call$1: function(e) {
      this.this_1.submitSay$0();
    }
  },
  Client_connect_closure: {
    "^": "Closure:10;this_0",
    call$1: function(_) {
      var t1, t2;
      t1 = this.this_0;
      ...
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new U.Client_connect__closure(t1)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = t1.webSocket;
      t2.toString;
      t2 = H.setRuntimeTypeInfo(new W._EventStream(t2, C.EventStreamProvider_close._eventType, false), [null]);
      t2.get$first(t2).then$1(new U.Client_connect__closure0(t1));
    }
  },
  Client_connect__closure: {
    "^": "Closure:10;this_1",
    call$1: function(e) {
      var t1, json, t2, response;
      t1 = this.this_1;
      json = C.JsonCodec_null_null.decode$1(J.get$data$x(e));
      t2 = J.getInterceptor$asx(json);
      response = t2.$index(json, "response");
      switch (response) {
        case "msg":
          t1.updateChatWindow$1(t2.$index(json, "msg"));
          break;
        case "info":
          t1.updateChatWindow$1(t2.$index(json, "msg"));
          break;
        default:
          t1.updateChatWindow$1("Invalid response: '" + H.S(response) + "'");
      }
    }
  },
  Client_connect__closure0: {
    "^": "Closure:10;this_2",
    call$1: function(_) {
      var t1 = this.this_2;
      t1.updateChatWindow$1("Connection disconnected to " + H.S(t1.webSocket.url) + ".");
    }
  },
  Client_connect_closure0: {
    "^": "Closure:10;this_3",
    call$1: function(_) {
      var t1 = this.this_3;
      t1.updateChatWindow$1("Failed to connect to " + H.S(t1.webSocket.url));
    }
  }
},
1],
...
function dart_precompiled($collectedClasses) {
  ...
  function Client(connectPending, webSocket) {
  ...
  function Client_closure(this_0) {
    this.this_0 = this_0;
  }
  Client_closure.builtin$cls = "Client_closure";
  if (!"name" in Client_closure)
    Client_closure.name = "Client_closure";
  $desc = $collectedClasses.Client_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Client_closure.prototype = $desc;
  function Client_closure0(this_1) {
    this.this_1 = this_1;
  }
  Client_closure0.builtin$cls = "Client_closure0";
  if (!"name" in Client_closure0)
    Client_closure0.name = "Client_closure0";
  $desc = $collectedClasses.Client_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Client_closure0.prototype = $desc;
  function Client_connect_closure(this_0) {
    this.this_0 = this_0;
  }
  Client_connect_closure.builtin$cls = "Client_connect_closure";
  if (!"name" in Client_connect_closure)
    Client_connect_closure.name = "Client_connect_closure";
  $desc = $collectedClasses.Client_connect_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Client_connect_closure.prototype = $desc;
  function Client_connect__closure(this_1) {
    this.this_1 = this_1;
  }
  Client_connect__closure.builtin$cls = "Client_connect__closure";
  if (!"name" in Client_connect__closure)
    Client_connect__closure.name = "Client_connect__closure";
  $desc = $collectedClasses.Client_connect__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Client_connect__closure.prototype = $desc;
  function Client_connect__closure0(this_2) {
    this.this_2 = this_2;
  }
  Client_connect__closure0.builtin$cls = "Client_connect__closure0";
  if (!"name" in Client_connect__closure0)
    Client_connect__closure0.name = "Client_connect__closure0";
  $desc = $collectedClasses.Client_connect__closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Client_connect__closure0.prototype = $desc;
  function Client_connect_closure0(this_3) {
    this.this_3 = this_3;
  }
  Client_connect_closure0.builtin$cls = "Client_connect_closure0";
  if (!"name" in Client_connect_closure0)
    Client_connect_closure0.name = "Client_connect_closure0";
  $desc = $collectedClasses.Client_connect_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Client_connect_closure0.prototype = $desc;
